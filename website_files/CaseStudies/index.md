...
<div class="card-deck mt-3">
	...
	<div class="card mb-4 d-block" style="width: 18rem;">
            <div class="card-body">
                <a href="2022/StringSimilarity"><h5 class="card-title">Integration using partial fractions and STACK</h5></a>
                <p class="card-text">Using STACK to build a self-discovery step by step learning path to teach an integration technique</p>
            </div>
	</div>
